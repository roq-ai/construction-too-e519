  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental, your one-stop-shop for all your tool needs. Rent easily, build efficiently with multiple outlets at your service."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental, your one-stop-shop for all your tool needs. Rent easily, build efficiently with multiple outlets at your service.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Store Employee" type="store-employee" abilities={appConfig.ownerAbilities} />
